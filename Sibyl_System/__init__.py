...
if ENV:
    ...
    CARDINAL = [int(x) for x in os.environ.get("CARDINAL", "").split()]
    DEVELOPERS = [int(x) for x in os.environ.get("DEVELOPERS", "").split()]
    MANAGERS = [int(x) for x in os.environ.get("MANAGERS", "").split()]
